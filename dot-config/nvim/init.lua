...
vim.keymap.set('n', '<leader>le', ":Lexplore 15<CR>", {  silent = true })
vim.keymap.set('n', '<Control>l', ":nhl<CR>", {  silent = true })
vim.keymap.set('n', '<leader>n', "<cmd>!nohup st &<CR><CR>", {  silent = true })
